...
const Modal = ({ isOpen, onClose, course }) => {
  ...
  return (
    <div 
      className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 dark:bg-opacity-70 z-50 transition-colors duration-200"
      role="dialog"
      aria-modal="true"
      aria-labelledby="modal-title"
    >
      <div className="bg-white dark:bg-gray-800 rounded-[12px] shadow-lg relative max-w-[538px] w-full transition-colors duration-200">
        <button
          className="absolute bg-white dark:bg-gray-800 right-0 top-0 z-20 rounded-full p-[5px] m-[15px] hover:text-gray-900 dark:hover:text-gray-100 transition-colors duration-200"
          onClick={onClose}
        ...
        <div className="w-full relative">
          ...
          <div className="flex gap-[10px] absolute bottom-[10px] left-[20px]">
            <div className="bg-[white] dark:bg-gray-700 px-[12px] rounded-[12px] text-gray-900 dark:text-gray-100 transition-colors duration-200">
              {t(course.duration)}
            </div>
            <div className="bg-[white] dark:bg-gray-700 px-[12px] rounded-[12px] text-gray-900 dark:text-gray-100 transition-colors duration-200">
              {t(course.title)}
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-medium text-gray-900 dark:text-gray-100 transition-colors duration-200">{t(course.center)}</span>
            </div>
            <div className="text-lg font-semibold text-blue-600 dark:text-blue-400 transition-colors duration-200">
              {course.price} {t("common.perMonth")}
            </div>
          </div>
          <h2 id="modal-title" className="text-xl font-bold text-gray-900 dark:text-gray-100 transition-colors duration-200">{t(course.name)}</h2>
          <p className="text-blue-500 dark:text-blue-400 text-lg font-semibold mt-2 transition-colors duration-200">
            {course.price.toLocaleString("uz-UZ")} {t("common.perMonthShort")}
          </p>

          <div className="mt-4">
            <h3 className="font-semibold flex gap-[10px] text-gray-900 dark:text-gray-100 transition-colors duration-200">
              <img src={pdp} alt={t("common.centerLogo")} />
              {t(course.center)}
            </h3>
            <div className="mt-[20px]">
              <div className="flex justify-between">
                <div className="flex items-center gap-[1px] w-1/2 text-[14px] text-gray-700 dark:text-gray-300 transition-colors duration-200">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
                    height="16"
                ...
                <div className="flex items-center gap-[5px] w-1/3 text-[14px] text-gray-700 dark:text-gray-300 transition-colors duration-200">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
              ...
              <div className="flex justify-between">
                <div className="flex items-center gap-[5px] w-1/2 text-[14px] text-gray-700 dark:text-gray-300 transition-colors duration-200">
                  <svg
                    width="14"
                    height="14"
                    viewBox="0 0 14 14"
