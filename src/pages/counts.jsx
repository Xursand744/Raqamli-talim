    ...
    <div className="container mt-[50px] md:mt-[100px] p-6 counts-section">
      <div className="grid grid-cols-1 justify-between md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        <div className="gridlar bg-gray-100 py-5 p-3 rounded-lg">
          ...
          <p className="text-[##F8F8F8] max-w-2xl">
            {t("metrics.centerDescription")}
          </p>
        </div>

        <div className="bg-[#E3EEFF] grid rounded-lg p-6">
        ...
        <div className="bg-[#E3EEFF] rounded-lg p-6">
          <div className="flex flex-col items-center justify-center h-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {[
          ...
          <div key={index} className="bg-[#E3EEFF] rounded-lg p-6">
