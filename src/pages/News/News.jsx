...
const NewsCard = ({ date, title, description, image, tags }) => (
  <motion.div
    ...
    className="flex bg-white rounded-xl shadow-sm overflow-hidden hover:shadow-xl transition-all duration-300"
  >
...
function News() {
  ...
  return (
    <div className="">
      <div className="mt-[100px] w-[1200px] mx-auto">
        <div className="w-full max-w-screen-xl mx-auto py-2 flex items-center justify-between gap-4 news-header">
          ...
          <div className="relative">
            <button
              className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md transition-colors border border-gray-200"
        ...
        <h1 className="text-[#222] text-[44px] font-bold mt-[40px]">
          Yangiliklar
        </h1>

        <div className="flex justify-between gap-[20px]">
          <motion.div>
            <div className="max-w-1/2 w-full p-4">
              <article className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
                <div className="max-w-[588px] relative h-full w-full overflow-hidden">
                  <img
                    src={newsBannerImage}
                    alt="Abstract design"
            ...
            <div className="flex flex-col items-center mt-12">
              {isLoading ? (
                ...
                <button
                  ...
                  className="group relative inline-flex items-center justify-center px-8 py-3 font-medium text-white bg-blue-600 rounded-full overflow-hidden transition-all duration-300 hover:bg-blue-700"
                >
