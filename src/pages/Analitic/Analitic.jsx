...
export default function Dashboard() {
    ...
    const metricsData = {
        min: {
            value: '7.3 mln',
            chart: Array(12).fill().map(() => Math.random() * 30 + 50)
        },
        avg: {
            value: '14.6 mln',
            chart: Array(12).fill().map(() => Math.random() * 30 + 60)
        },
        max: {
            value: '24.5 mln',
            chart: Array(12).fill().map(() => Math.random() * 30 + 70)
        }
    }
    ...
    const chartData = {
        ...
        datasets: [
            {
                data: Array(12).fill().map(() => Math.random() * 40 + 40),
    ...
    return (
        <div className="max-w-[1280px] w-full mx-auto p-2 sm:p-4 mt-[100px]">
            ...
            <nav className="flex flex-wrap items-center gap-1 text-xs sm:text-sm text-gray-600 mb-4 sm:mb-8">
                ...
                <a href="#" className="hover:text-blue-600">IT-maslahatlar</a>
                <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4" />
                <a href="#" className="hover:text-blue-600">IT yo'nalishlar</a>
                <ChevronRight className="w-3 h-3 sm:w-4 sm:h-4" />
                       ...
                       <div className="flex absolute bottom-3 left-2 flex-wrap gap-2">
                        ...
                        <div className="space-y-2 sm:space-y-4 p-3">
                            ...
                            <p className="text-sm  sm:text-base text-gray-600 leading-relaxed">
                                bu dasturiy ta'minotning yashirin qismi bo'lib, foydalanuvchilar ko'ra olmaydigan, lekin dastur yoki veb-saytning ishlashini ta'minlaydigan mexanizmilarni o'z ichiga oladi. Backend ma'lumotlar bazasi bilan ishlaydi, biznes mantiqlarni amalga oshiradi va foydalanuvchi interfeysi (frontend) bilan o'zaro aloqa qiladi.
                            </p>
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3">
                        <MetricCard
                            title="Eng kam oylik"
                            value="7.3 mln"
                            data={Array(12).fill().map(() => Math.random() * 30 + 50)}
                        />
                        <MetricCard
                            title="O'rtacha oylik"
                            value="14.6 mln"
                            isActive={true}
                            data={Array(12).fill().map(() => Math.random() * 30 + 60)}
                        />
                        <MetricCard
                            title="Eng ko'p oylik"
                            value="24.5 mln"
                            data={Array(12).fill().map(() => Math.random() * 30 + 70)}
                        />
                    </div>

                    {/* Chart */}
                    <div className="rounded-xl bg-gray-50 p-4 sm:rounded-2xl shadow-sm">
                        <h3 className="text-gray-700 text-sm sm:text-base font-medium mb-4 sm:mb-6">Talablar grafigi</h3>
