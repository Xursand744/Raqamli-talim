...
import { MicroscopeIcon as MagnifyingGlassIcon, ChevronDownIcon } from 'lucide-react'
    ...
    <div className="container mt-[100px] p-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {filteredJobs.map((job) => (
          <div key={job.id} className="bg-[#F8F9FF] rounded-xl p-4 hover:shadow-lg transition-shadow">
            <div className="relative mb-4">
              ...
              <div className="absolute bottom-1 left-2 bg-white px-2 py-1 rounded-full text-sm font-medium flex items-center gap-1">
                <span className="text-orange-500">👑</span>{job.id}
              </div>
