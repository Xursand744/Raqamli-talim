    ...
    <div className="overflow-hidden">
        ...
        >
          {slides.map((slide, index) => (
            <SwiperSlide key={index}>
              <div className="w-full h-auto flex flex-col md:flex-row items-center justify-center border border-[#E0E0E0] rounded-[8px] overflow-hidden">
                <img
                  className="w-[282px] h-[250px] md:h-full object-cover"
                  src={slide.img}
                  alt="Slide image"
                />
                <div className="w-full md:w-1/2 p-4 flex flex-col justify-between">
                  <h1 className="text-[14px] font-medium pb-[20px] w-full text-center md:text-left">
                    {slide.text}
                  </h1>
      ...
      <div className="mb-[-120px]">
        <div className="w-full flex justify-center items-center mt-[100px]">
          <div className="max-w-[800px] w-full h-[420px] relative">
            <img
              src={ItTalentsImage}
